...
const values: Value[] = [
  {
    ...
    label: "Based in Mirik, Darjeeling",
    code: "LOC-01",
  },
  {
...
function ValueModule({ value, index }: { value: Value; index: number }) {
  return (
    ...
    >
      ...
      <p className="relative z-10 text-white font-bold text-sm leading-snug mt-4">
        {value.label}
      </p>
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          ...
          >
            <div className="absolute -top-10 -right-10 font-mono-display text-[200px] font-black text-white/[0.01] select-none pointer-events-none uppercase">
              Trust
            </div>
            <h3 className="text-3xl font-bold text-white mb-6 leading-tight max-w-lg">
              We aren&apos;t a faceless corporation. We are your neighbors.
            </h3>
            <p className="text-text-secondary text-lg leading-relaxed max-w-xl opacity-80">
              Sirf Local empowers local businesses with Data, Design, and Tech.
              When you work with us, you are a partner in the regional
              ecosystem.
            </p>
          </motion.div>
